                ...
                <?php
               		...
               		echo $this->Form->input('paciente_id',
               			array(
               				...
               				'options' => array($paciente['Paciente']['id']=> $paciente['Paciente']['Nombre'])
               				)
               			);
                  ...
                  ?>
                  <!-- 
                  <?php echo $this->Form->input('farmacos', array('class' => 'form-control', 'label' => 'Farmacos', 'rows' =>'5')); ?> -->
                
			</fieldset>
                <?php echo $this->Form->end(array('label' => 'Guardar paciente y ocultarlo de lista de espera', 'class' => 'noquiere btn btn-success hide-offline'));?>
			</p>
		</div>
	</div>
</div>
