        ...
        <div class="col-md-12">
            <?php echo $this->Form->create('Paciente', array('role' => 'form', 'novalidate')); ?>
                <fieldset>
                    ...
                    echo $this->Form->input('Ciudad', array('class' => 'form-control', 'label' => 'Ciudad'));
                ...
                <p>
                <?php echo $this->Form->end(array('label' => 'Editar Paciente', 'class' =>'btn btn-success')); ?>
                </p>
            </div>
        </div>
    </div>
